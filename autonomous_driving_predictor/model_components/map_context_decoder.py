...
from autonomous_driving_predictor.core_algorithms.nan_checker import check_nan_inf
from autonomous_driving_predictor.neural_networks import AttentionLayer
from autonomous_driving_predictor.neural_networks import MLPLayer
from autonomous_driving_predictor.neural_networks import FourierEmbedding, MLPEmbedding
from autonomous_driving_predictor.core_algorithms.geometry import angle_between_2d_vectors
from autonomous_driving_predictor.core_algorithms.graph import merge_edges
from autonomous_driving_predictor.core_algorithms.weight_init import weight_init
from autonomous_driving_predictor.core_algorithms.geometry import wrap_angle
import pickle


class MapContextDecoder(nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout: float,
                 map_token) -> None:
        super(MapContextDecoder, self).__init__()
